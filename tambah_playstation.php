...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="tampil_paelanggan.php">Pelanggan</a>
                                </nav>
                            </div>
		...
		<form action="proses_tambah_playstation.php" method="post">
			Jenis Playstation : 
			<input type="text" name="jenis_playstation" value="" class="from-control">
			Tahun Produksi : 
