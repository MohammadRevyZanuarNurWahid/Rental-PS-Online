...
<html lang="en">
	...
	<table class="table table-hover table-striped">
		<thead>
			<tr>
				<th>NO</th><th>PLAYSTATION</th><th>TAHUN PRODUKSI</th>
				<th>AKSI</th>
			</tr>
		</thead>
		<tbody>
<?php
			...
			while ($data_playstation=mysqli_fetch_array($qry_playstation)) {
				$no++;?>
			<tr>
			<td><?=$no?></td><td><?=$data_playstation['jenis_playstation']?></td>
			<td><?=$data_playstation['tahun_produksi']?></td>
			
			<td> <a href="hapus_playstation.php?id_playstation=<?=$data_playstation['id_playstation']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">HAPUS</a> </td>
				</tr>
		<?php
		}
		?>
